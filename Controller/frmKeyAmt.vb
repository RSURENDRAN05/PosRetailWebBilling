...
Public Class frmKeyAmt
    Dim numstr As String = ""
    Dim Title As String = "Enter Amount"
    ...
    Private Sub _TXTPASS_KeyDown(sender As Object, e As KeyEventArgs) Handles _TXTPASS.KeyDown
        Try
            If _TXTPASS.EditValue Is Nothing OrElse _TXTPASS.Text = "" Then
                _FunctionKeyBoardModule.gs_keyboardValueDecimal = 0
                Me.DialogResult = Windows.Forms.DialogResult.Cancel
                Me.Close()
            Else
                _FunctionKeyBoardModule.gs_keyboardValueDecimal = _TXTPASS.EditValue
    ...
    Private Sub frmKeyAmt_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            _TXTPASS.Text = ""
            _TXTPASS.Select()
            numstr = ""
