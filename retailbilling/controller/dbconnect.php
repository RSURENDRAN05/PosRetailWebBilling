...
class database {
    ...
    public function _InsertProductMaster($dim_item_barcode, $dim_item_name, $dim_business_type, $dim_main_id, $dim_cate_id, $dim_tax_id, $dim_cost_price, $dim_sell_price, $dim_op_stock, $dim_stock_in,
            $dim_stock_out, $dim_stock_cur, $dim_com_id, $dim_loc_id, $dim_status) {
        $conn = $this->connect();
...
//Ledger Entry
    ...
    //Store Sales 
    public function SaveInvoiceDtl($psid_invoice_sno, $psid_invoice_prf, $psid_invoice_date, $psid_invoice_trno, $psid_invoice_description,
            ...
            $psid_invoice_taxinex, $psid_invoice_taxvalue, $psid_invoice_taxamt, $psid_invoice_netamt, $psid_invoice_billtype, $psid_invoice_saletype,
            $psid_invoice_status, $psid_invoice_userid) {
        $conn = $this->connect();
    ...
    public function SaveInvoiceHdr($psih_invoice_trno, $psih_invoice_date, $psih_invoice_description, $psih_invoice_prefix, $psih_invoice_tqty, $psih_invoice_tamount,
...
//Employee Registration
    public function EmployeeInsert($emp_firstname, $emp_lastname, $emp_shortname, $emp_idtype, $emp_passportic, $emp_nationality,
            $emp_passexpire, $emp_visaexpire, $emp_contactno, $emp_contactname, $emp_emergencyno, $emp_compid,
            $emp_branchid, $emp_position, $emp_bankname, $emp_accountname, $emp_accountno, $emp_image, $emp_joindate,
            $emp_basicsalary, $emp_basicrate, $emp_otrate, $emp_othrsrate, $emp_active, $emp_allowance) {
        $conn = $this->connect();
    ...
    public function EmployeeUpdate($emp_registerid, $emp_firstname, $emp_lastname, $emp_shortname, $emp_idtype, $emp_passportic, $emp_nationality,
            $emp_passexpire, $emp_visaexpire, $emp_contactno, $emp_contactname, $emp_emergencyno, $emp_compid,
            $emp_branchid, $emp_position, $emp_bankname, $emp_accountname, $emp_accountno, $emp_image, $emp_joindate,
            $emp_basicsalary, $emp_basicrate, $emp_otrate, $emp_othrsrate, $emp_active, $emp_allowance) {
        $conn = $this->connect();
